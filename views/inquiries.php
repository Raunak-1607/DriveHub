<?php // Employee - Customer Inquiries ?>
<!DOCTYPE html>
<html>
                ...
                if (!empty($inquiriesData)) {
                    foreach ($inquiriesData as $inquiry) {
                        ...
                        if ($inquiry['status'] === 'Pending') {
                            echo "<button class='btn-mark-resolved action-btn' data-action='resolve' data-id='" . htmlspecialchars($inquiry['id']) . "'>Mark Resolved</button>";
                        }
                        echo "<button class='btn-view action-btn' data-action='view' data-id='" . htmlspecialchars($inquiry['id']) . "'>View</button>";
                        echo "</div></td>";
                        echo "</tr>";
                    }
                }
