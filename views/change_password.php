...
<body>
    ...
    <div class="main-content">
        ...
        <div class="profile-card">
            <?php
            if(isset($_GET['err'])) {
                if($_GET['err'] == 'password_mismatch') echo "<p style='color: red; margin-bottom:15px;'>New passwords do not match.</p>";
                if($_GET['err'] == 'empty_fields') echo "<p style='color: red; margin-bottom:15px;'>Please fill in all fields.</p>";
            }
            ?>
