<?php // Employee - Sales Transactions ?>
<!DOCTYPE html>
<html>
        ...
        <div class="table-container">
            <div class="section-header">
                <div>
                    ...
                    <p class="section-subtitle">Create and process sales &mdash; Pending &rarr; Sold (marks the vehicle as unavailable)</p>
                </div>
            ...
            <table id="salesTable">
                ...
                if (!empty($salesData)) {
                    foreach ($salesData as $sale) {
                        ...
                        echo "<button class='btn-view action-btn' data-action='view' data-id='" . htmlspecialchars($sale['id']) . "'>View</button>";
                        echo "</div></td>";
                        echo "</tr>";
                    }
                }
